...
interface ProductV1ApiSpec {
    ...
    fun findProducts(
        ...
        @Schema(name = "기술 카테고리", description = "BACKEND/FRONTEND/...") @RequestParam(required = false) category: TechCategory?,
        @Schema(name = "난이도", description = "BEGINNER/INTERMEDIATE/ADVANCED") @RequestParam(required = false) level: Level?,
